...
import {  foodimg, reactfood, yt,Travel } from "../../assets/index";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-14">
        ...
        /> */}
        <ProjectsCard
          title="Travel Guide Website with Travel Advisor API Integration"
          des=" 
          Created a travel guide website that offers travel recommendations and information using Travel Advisor API.
Provided users with real-time data and insights on popular travel destinations.
Technologies used: MongoDB, Express, React, Node.js, Mongoose."
          src={Travel}
        />
        <ProjectsCard
          title="Food Website"
